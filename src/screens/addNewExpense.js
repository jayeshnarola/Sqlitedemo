...
export default class AddNewExpense extends Component {
    ...
    componentWillMount() {
        ...
        if (this.props && this.props.navigation && this.props.navigation.state && this.props.navigation.state.params && this.props.navigation.state.params.expense) {
            this.setState({ expenseName: this.props.navigation.state.params.expense.eName, desc: this.props.navigation.state.params.expense.desc, eId: this.props.navigation.state.params.expense.eId, category: this.props.navigation.state.params.expense.cId, amount: this.props.navigation.state.params.expense.amount, isUpdateCall: this.props.navigation.state.params.isUpdateCalled });
        }
    }
    getCategoryList() {
        let categories = [];
